...
if(SaveNormOb==T){
  ...
  CODE <- syn_temp$store(synapseclient$Folder(name = "Metadata", parentId = "syn23573925"))
...
clean_md <- clean_md[ clean_md$FailQC_SampleSwapped ==0,]
  ...
  ENRICH_OBJ <-  syn_temp$store( synapseclient$File( path='ROSMAP_All_sageseqr_Meta.RData', name = 'All Rosmap Sagseqr MetaData', parentId=CODE$properties$id ), used = Syns_Used, activityName = activityName, executed = thisFile, activityDescription = activityDescription)
    all.annotations$dataSubType = 'Metadata'
    syn_temp$setAnnotations(ENRICH_OBJ, annotations = all.annotations)
  
    CODE <- syn_temp$store(synapseclient$Folder(name = "Count_Data", parentId = "syn23573925"))   
  
    save(cqn_counts, clean_md, file = 'ROSMAP_All_sageseqr_Counts.RData')
  ENRICH_OBJ <-  syn_temp$store( synapseclient$File( path='ROSMAP_All_sageseqr_Counts.RData', name = 'All Rosmap Sagseqr MetaData', parentId=CODE$properties$id ), used = Syns_Used, activityName = activityName, executed = thisFile, activityDescription = activityDescription)
    all.annotations$dataSubType = 'Metadata'
    syn_temp$setAnnotations(ENRICH_OBJ, annotations = all.annotations)
} 
